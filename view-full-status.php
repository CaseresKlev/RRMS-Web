    ...
    <div class="container body">
      <div class="main_container">
        ...
        <?php
          ...
          $query = "SELECT paper_trail.id, book.book_title, paper_stat.title, paper_trail.origin, paper_stat.Description, isdone, date FROM paper_trail INNER JOIN book on book.book_id = paper_trail.book_id INNER JOIN paper_stat on paper_stat.id = paper_trail.p_sat_id WHERE book.book_id = $book_id";
              ...
              <table class="table">
                <thead>
                  <tr>
                    ...
                    echo "Paper status: " . $paper_stat ?></h3></th>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        while ($rowCom = $result->fetch_assoc()) {
                          ...
                          echo '<td scope="col" style=" border: 1px solid black; border-collapse: collapse;">'. $rowCom['parts'] .'</td>
                      <td scope="col" style=" border: 1px solid black; border-collapse: collapse;">'. $rowCom['comments'] .'
                      </td>
                      <td scope="col" style=" border: 1px solid black; border-collapse: collapse;"> <input class="form-control input-md" id="pageno" type="text" style="font-weight: bold; pattern="[0-9-]{3}" name="'. $book_id .'"readonly value="'. $rowCom['page'] .'"></td>
