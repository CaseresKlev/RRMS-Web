...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 06, 2018 at 05:54 PM
...
(1, 'Sales', 'Gamponia', 'Aribe', 'JR', 'Valencia Bukidnon', '0897675', 'klbgrvhb@gmail.com', ''),
(2, 'Klevie', 'jun', 'caseres', '', 'add', '787978', 'ssssssss', ''),
(3, 'Loyd', 'Toriano', 'Gonzales', '', 'Kalilangan Bukidnon', '097654356', 'loyd@gmail.com', '');
...
(1, 'This is Title', '', '2018-09-05', 20, 0, 'Conceptualized', 0, 0, 0, '', '', 0),
(2, 'This is My new Research', '', '2018-09-05', 20, 0, 'Conceptualized', 0, 0, 0, '', '', 0),
(3, '3 Reserch', '', '2018-09-05', 20, 0, 'Conceptualized', 0, 0, 0, '', '', 0),
(4, 'New research', '', '2018-09-05', 20, 0, 'Conceptualized', 0, 0, 0, '', '', 0);
...
INSERT INTO `comments` (`id`, `trail_id`, `parts`, `comments`, `page`) VALUES
(1, 5, 'Introduction', 'Coments', '1');
...
--
-- Dumping data for table `forwarded_sub`
--

INSERT INTO `forwarded_sub` (`id`, `title`) VALUES
(1, 'Forwarded to Research Committee'),
(2, 'Forwarded to Ethics Committee');
...
INSERT INTO `paper_stat` (`id`, `title`, `description`, `hassub`, `optional`) VALUES
...
(3, 'Paper Revision 1', 'Submission a preliminary paper.', 0, 0),
(4, 'Forwarded to Research and Ethics Committee ', 'Paper forwarded to Research and Ethics Committee for review.', 1, 0),
(5, 'Paper Revision 2', 'Submission of second paper revision by uuthor.', 0, 0),
...
(8, 'Publication', 'Paper is/are ready for publication.', 0, 0),
(9, 'Final Paper', 'Submission of final paper.', 0, 0),
(10, 'Paper Dissemination', 'The final paper was disseminated.', 0, 0),
(11, 'Awards Earned', 'Paper received an awards.', 0, 1),
(12, 'Research Utilization', 'The Paper was Utilized.', 0, 0);
...
INSERT INTO `paper_trail` (`id`, `book_id`, `p_sat_id`, `file_loc`, `origin`, `isdone`, `date`) VALUES
(1, 1, 1, '', '', 1, '2018-09-05 14:32:36'),
(2, 2, 1, '', '', 1, '2018-09-05 14:34:49'),
(3, 3, 1, '', '', 1, '2018-09-05 14:37:19'),
(4, 3, 2, '', '', 1, '0000-00-00 00:00:00'),
(5, 4, 1, '', 'Research Ethics Committee', 1, '2018-09-05 21:52:48');
