...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 18, 2018 at 08:06 PM
...
(1, 'Klevie Jun', 'Roflo', 'Caseres', '', 'Apo Macote', '9876543', 'kjjhgfgghb@gmail.com', '');
...
(1, 'This is Titled', 'awdawda', '2018-08-01', 1, 0, 'Unpublish', 1, 0, 0, 'cover/5b78576f477f95.55567729.jpg', 'book/5b78576f47f574.34159490.pdf', 0);
...
INSERT INTO `bookhistory` (`id`, `book_id`, `book_stat`, `dis_type`, `dis_convension`, `dis_location`, `pub_issn`, `pub_journal`, `pub_type`, `date`) VALUES
(1, 1, 'Unpublish', '', '', '', '', '', '', '2018-08-01');
...
(3, 1, 'GlFideD1w3SJ0zjbe4YN2Y4abexoaSDW');
