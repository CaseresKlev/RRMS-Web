...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 08, 2018 at 06:14 PM
...
(3, 'BASIC ACCOUNTING', 'We have studied economic activities which have been converted into business activities. In business activity a lot of Ã¢â‚¬Å“give & takeÃ¢â‚¬Â exist which is known as transaction. Transaction involves transfer of money or moneyÃ¢â‚¬â„¢s worth. Thus exchange of money, goods & services between the parties is known to have resulted in a transaction. It is necessary to record all these transactions very systematically & scientifically so that the financial relationship of a business with other persons may be properly understood, profit & loss and financial position of the business may be worked out at a particular date. The procedure to record all these transactions is known as Ã¢â‚¬Å“Book-keepingÃ¢â‚¬Â.', '1955-03-12', 4, 0, 'Unpublish', 1, 0, 'cover/default-book-cover.png', 'book/5b692582cfbd61.70578984.doc');
