...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 10, 2018 at 08:49 PM
...
-- Procedures
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `randomizer` ()  begin
      declare i int Default 0 ;
      declare random char(20) ;
      myloop: loop
      set random=conv(floor(rand() * 99999999999999), 20, 36) ;
      insert into `referencekey` (`id`, `refkey`) VALUES (i+1,random) ;
      set i=i+1;
      if i=5 then
        leave myloop;
	end if;
...
(965, 'bQdlvrZJ', 'STUDENT', 0, '2018-08-10'),
